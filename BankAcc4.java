...
public class BankAcc4 {
    ...
    private int acNo;
    private Float acBalance=0.00f;
    private String name,password,address;
    private long phNo=0;
    private Stack send = new Stack();
    private Stack recv = new Stack();
    ...
    public void registerUser() {
        ...
        try {
            ...
            System.out.println("Invalid input... Enter an appropriate value");
            sc.next();
            phNo = sc.nextLong();
        }
    ...
    public int transfer(BankAcc4 dest, Float amt) {
        if (amt >= acBalance)
            return 0;
        acBalance -= amt;
        dest.acBalance += amt;
        ...
        String s ="";
        s = s+this.acNo + " " + this.name +" debited by Rs." +amt + " Sent to: Account No."+dest.acNo+", "+dest.name +" current Balance:"+this.acBalance+"......";
        send.push(s);
        String m="";
        m = m+dest.acNo + " " + dest.name +" credited by Rs." +amt + " received from: Account No."+this.acNo+", "+this.name +" current Balance:"+dest.acBalance+"......";
        dest.recv.push(m);
        return 1;
    }
    ...
    public static void main(String[] args) {
        ...
        BankAcc4 b1 = new BankAcc4();
        BankAcc4 b2 = new BankAcc4();
        BankAcc4 b3 = new BankAcc4();
        boolean f1=false;
        boolean f2=false;
        boolean f3=false;
        int c=0;
        ...
        while(true){
            ...
            switch(choice)
            {
                ...
                case 7:
                    ...
                    System.out.println("Debits: "+b1.send);
                    System.out.println("Credits: "+b1.recv);
                        
                    }
                    else if(f2==true)
                    {
                    System.out.println("Account Statement:");
                    System.out.println("Debits: "+b2.send);
                    System.out.println("Credits: "+b2.recv);
                    }

                    else if(f3==true)
                    {
                    System.out.println("Account Statement:");
                    System.out.println("Debits: "+b3.send);
                    System.out.println("Credits: "+b3.recv);
                    }
